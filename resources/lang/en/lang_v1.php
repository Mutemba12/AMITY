<?php
return [
    "enable_editing_product_from_purchase" => 'Enable editing plot price from purchase screen',
    ...
    'list_products' => 'List Plots',
    'list_expenses' => 'List Expenses',
    'add_expiry' => 'Add item expiry',
    'add_manufacturing_auto_expiry' => 'Add manufacturing date & expiry period',
    'tooltip_enable_expiry' => 'Enable plot expiry. <br/> <br/><b>Add item expiry</b>: To directly add item expiry only. <br/> <b>Add manufacturing date & expiry period</b>: To add manufacturing date & expiry period and calculate expiry date based on that.',
    'quantity' => 'Quantity',
    'on_product_expiry' => 'On Plot Expiry',
    'keep_selling' => 'Keep Selling',
    'stop_selling' => 'Stop Selling n days before',
    'tooltip_on_product_expiry' => 'Specify action that needs to be done on Plot expiry. <br><br> <b>Keep Selling</b>: Products will be kept on selling after expiry also. <br> <b>Stop Selling</b>: Stop selling item n days before expiry.',
    ...
    'recent_product_quantity' => 'Go to plot quantity',
    'full_screen' => 'Press F11 to go Full Screen',
    'Uncategorised' => 'Uncategorised',
    'no_products_to_display' => 'No Plot to display',
    'item_out_of_stock' => 'Plot out of stock',
    'go_back' => 'Go Back',
    'disable_pay_checkout' => 'Disable Multiple Pay',
    'disable_draft' => 'Disable Draft',
    'disable_express_checkout' => 'Disable Express Checkout',
    'hide_product_suggestion' => 'Don\'t show Plot suggestion',
    ...
    'tooltip_calculation_percentage' => '<b>Selling price = Selling price Set For the plot + Calculation percentage </b> <br/><br/> You can specify percentage as positive to increase and negtive to decrease selling price.',
    'success' => 'Success',
    'edit_customer_group' => 'Edit Customer Group',
    'customer_groups_report' => 'Customer Groups Report',
    'none' => 'None',
    'enable_imei_or_sr_no' => 'Enable Plot description, IMEI or Serial Number',
    'tooltip_sr_no' => 'Enable or disable adding plot description, IMEI or Serial number while selling plot in POS screen',
    'description' => 'Description',
    'sell_line_description_help' => 'Add plot IMEI, Serial number or other informations here.',
    ...
    'suppliers' => 'Suppliers',
    'customers' => 'Customers',
    'enter_product_name_to_print_labels' => 'Enter plot name to print labels',
    'manage_product_variations' => 'Manage plot variations',
    ...
    'pending' => 'Pending',
    'ordered' => 'Ordered',
    'search_product_placeholder' => 'Enter Plot Number / SKU / Scan bar code',
    'fixed' => 'Fixed',
    ...
    'due' => 'Due',
    'partial' => 'Partial',
    'no_of_products' => 'Number of plots',
    ...
    'product_purchase_report' => 'Plot Purchase Report',
    'unit_perchase_price' => 'Unit Purchase Price',
    'search_product' => 'Search Plot',
    'product_sell_report' => 'Plot Sell Report',
    ...
    'product_label' => 'Plot Label',
    'qty_label' => 'Quantity Label',
    'unit_price_label' => 'Unit Price Label',
    'subtotal_label' => 'Subtotal Label',
    'product_details_to_be_shown' => 'Plot details to be shown',
    'show_brand' => 'Show Estate',
    'show_sku' => 'Show SKU',
    ...
    'product_imei_or_sn' => '(Plot IMEI or Serial Number)',
    'purchase_already_exist' => "Plot can't be deleted because purchases related to 
								this plot exist",
    'opening_stock_sold' => "Plot can't be deleted because some stocks are sold",
    'stock_adjusted' => "Plot can't be deleted because some stocks are adjusted",
    'product_delete_success' => 'Plot deleted successfully',
    'manage_products' => 'Manage your plots',
    'all_products' => 'All Plots',
    'login' => 'Login',
    'register' => 'Register',
    'username' => 'Username',
    'password' => 'Password',
    ...
    'required' => 'Required',
    'optional' => 'Optional',
    'name_ins' => 'Name of the plot',
    'brand_ins' => 'Name of the Estate',
    'brand_ins2' => 'If not found new estate with the given name will be created',
    ...
    'sku_ins' => 'Plot SKU. If blank an SKU will be automatically generated',
    'barcode_type_ins' => 'Barcode Type for the plot.',
    ...
    'expires_in_ins' => 'Plot expiry period (Only in numbers)',
    ...
    'variation_name_ins' => 'Required if plot type is variable',
    'variation_name_ins2' => 'Name of the variation (Ex: Size, Color etc )',
    'variation_values_ins' => 'Required if plot type is variable',
    ...
    'purchase_price_inc_tax_ins2' => "Purchase Price (Including Tax) (Only in numbers)<br><br>For variable plots '|' separated values with <br>the same order as Variation Values <br>(Ex: 84|85|88)",
    ...
    'purchase_price_exc_tax_ins2' => "Purchase Price (Excluding Tax) (Only in numbers)<br><br>For variable plot '|' separated values with <br>the same order as Variation Values <br>(Ex: 84|85|88)",
   ...
   'only_applicable_to_single_product' => 'Only applicable to single plot',
   ...
   'tooltip_enable_racks' => 'Enable this to add rack details of a Plot for different business locations while adding products',
   'rack_details' => 'Rack/Row/Position Details',
   'tooltip_rack_details' => 'Enter details of where the plot is kept in the store, for different business locations.',
   ...
   'product_sold_details_register' => 'Details of plots sold',
   ...
   'tooltip_import_opening_stock' => 'This feature is used to import opening stock of already added products. If the products are not added in the system then it is advisable to use import products for adding Plot details with opening stock.',
   'design' => 'Design',
   ...
   'show_product_expiry' => 'Show plot expiry',
   'show_lot_number' => 'Show lot number',
   'expiry' => 'Expiry',
   'lot' => 'Lot',
   'lot_n_expiry' => 'Lot & Expiry',
   'pos_edit_product_price_help' => 'Edit plot Unit Price and Tax',
   'name' => 'Name',
   ...
   'tooltip_sell_product_column' => 'Click <i>plot number</i> to edit price, discount & tax. <br/>Click <i>Comment Icon</i> to enter serial number / IMEI or additional note.<br/><br/>Click <i>Modifier Icon</i>(if enabled) for modifiers',
   ...
   'duplicate_product' => 'Duplicate plot',
   ...
   'subtotal_editable_help_text' => 'Check this to make Subtotal field editable for each Plot in POS screen',
   ...
   'payment_paid_notification' => 'Payment Paid Notification',
    ...
    'edit_product_price_from_sale_screen' => 'Edit Plot price from sales screen',
    'edit_product_discount_from_sale_screen' => 'Edit Plot discount from Sale screen',
    ...
    'product_description' => 'Plot Description',
    ...
    'recurring_invoice_error_message' => 'Unable to create invoice for Subscription no.: <i>:subscription_no</i>. Required stock not available for Plot <i>:product_name</i>',
    'load_more' => 'Load More',
    'cash_flow' => 'Cash Flow',
    'subscribe' => 'Subscribe',
    ...
    'unit_cannot_be_deleted' => 'Plot exist with this unit; Cannot be deleted',
    'expiry_date_in_business_date_format' => 'Stock expiry date in <b>Business date format</b>',
    'deactivate_selected' => 'Deactivate Selected',
    'products_deactivated_success' => 'Plots deactivated successfully',
    'deactive_product_tooltip' => 'Deactivated plots will not be available for purchase or sell',
    'reactivate' => 'Reactivate',
    'allow_overselling_help' => 'Check this field to allow a Plot to sell more than the available quantity. Oversold quantity will be adjusted automatically from future stock.',
    ...
    'product_stock_details' => 'Plot Stock Details',
    'search' => 'Search',
    ...
    'enable_service_staff_in_product_line' => 'Enable service staff in plot line',
    'inline_service_staff_tooltip' => 'If enabled different service staffs can be assigned for different plots for an order/sale',
    'line_orders' => 'Line Orders',
    'total_tax' => 'Total Tax',
    'total_discount' => 'Total Discount',
    'net_price' => 'Net Price',
    'select_same_for_all_rows' => 'Select same value for all plots',
    'edited' => 'Edited',
    'by' => 'By',
    ...
    'products_could_not_be_deleted' => "Some plots couldn't be deleted because it has transactions related to it.",
    'price' => 'Price',
    ...
    'profit_by_products' => 'Profit by plots',
    'profit_by_categories' => 'Profit by categories',
    'profit_by_brands' => 'Profit by estates',
    ...
    'friday' => 'Friday',
    'saturday' => 'Saturday',
    'show_product_image' => 'Show plot image',
    'view_user' => 'View User',
    ...
    'view_purchase_price_tooltip' => 'Permission to view purchase price in plot details',
    'created' => 'Created',
    'updated' => 'Updated',
    'deleted' => 'Deleted',
    'day' => 'Day',
    ...
    'tooltip_not_for_selling' => 'If checked, plot will not be displayed in sales screen for selling purposes.',
    'show_reward_point' => 'Show reward point',
    'enable_booking' => 'Enable Bookings',
    'bulk_edit' => 'Bulk Edit',
    'bulk_edit_products' => 'Bulk Edit plots',
    'search_product_to_edit' => 'Search plot to edit',
    ...
    'added_on' => 'Added On',
    'quantity_mismatch_exception' => 'ERROR: NOT ALLOWED: Mismatch between sold and available quantity. Plot: :product',
    'roles_and_permissions' => 'Roles and Permissions',
    'admin_role_location_permission_help' => 'Admin can access all locations',
    'edit_product_price_from_pos_screen' => 'Edit plot price from POS screen',
    'edit_product_discount_from_pos_screen' => 'Edit plot discount from POS screen',
    ...
    'product_location_help' => 'Locations where plot will be available.',
    ...
    'add_location_to_the_selected_products' => 'Add location to the selected plots',
    'remove_location_from_the_selected_products' => 'Remove location from the selected plots',
    ...
    'product_business_location_tooltip' => 'Plots will be available only in this business locations',
    'product_not_assigned_to_any_location' => 'Plot not assigned to any locations',
    'packed' => 'Packed',
    'shipped' => 'Shipped',
    'delivered' => 'Delivered',
    ...
    'enable_updating_product_price_tooltip' => 'If enabled plot purchase price and selling price will be updated after a purchase is added or updated',
    ...
    'product_not_found_exception' => 'Plot with SKU :sku not found  on row :row',
    'price_group_not_found_exception' => 'Price Group with name :pg not found on row :row',
    'product_grp_prices_imported_successfully' => 'Plot group prices imported successfully',
    ...
    'price_group_import_istruction2' => 'Only selling price group prices of the Plot will be updated. Any blank price will be skipped.',
    ...
    'configure_product_search' => 'Configure Plot search',
    ...
    'weighing_product_sku_length' => 'Plot sku length',
    ...
    'sku_not_match' => 'No Plot found with sku :sku',
    ...
    'import_sale_product_not_found' => 'Plot with name :product_name or sku :sku not found in row :row',
    ...
    'product_name_or_sku_is_required' => 'Plot Number or SKU is required',
    ...
    'product_name_single_only' => 'Plot number (Single or combo products only)',
    'product_sku' => 'Plot SKU',
    'product_unit' => 'Plot Unit',
    ...
    'product_cannot_be_empty_in_row' => 'Either plot number or Plot SKU is required in row :row',
    'quantity_cannot_be_empty_in_row' => 'Plot quantity is required in row :row',
    ...
    'labels_for_product_custom_fields' => 'Labels for Plot custom fields',
    ...
    'product_locations_ins' => 'Comma separated string of business location names where Plot will be available',
    'product_locations' => 'Plot locations',
    'view_products' => 'View Products',
    'pos_screen_featured_products' => 'POS screen Featured Products',
    'featured_products_help' => 'Selected products will be shown on top of the pos screen Plot suggestion for quick access',
    ...
    'either_product_name_or_sku_required' => 'Either plot number (for single and combo only) or Plot sku required',
    ...
    'recurring' => 'Recurring',
    'view_product_stock_value' => 'View Plot stock value',
    'added' => 'Added',
    ...
    'profit_note' => '<b>Note:</b> Profit by products/categories/estates only considers inline discount. Invoice discount is not considered.',
    'is_refund' => 'Is refund',
    ...
    'product_stock_history' => 'Plot stock history',
    ...
    'product_brochure' => 'Plot brochure',
    ...
    'show_pricing_on_product_sugesstion' => 'Show pricing on Plot suggestion tooltip',
    ...
    'variation_sku_ins' => 'SKUs of each variations separated by "|" if Plot type is variable',
    ...
    'exp_date_instructions' => 'Only if Plot Expiry is enabled. You can enable Plot expiry from <br><code>Business Settings > Plot > Enable Plot Expiry</code>',
    ...
    'secondary_unit_help' => 'Allows user to enter Plot quantity in secondary unit during purchase/sell',
